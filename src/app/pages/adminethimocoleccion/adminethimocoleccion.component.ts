...
@Component({
  selector: "app-adminethimocoleccion",
  templateUrl: "./adminethimocoleccion.component.html",
})
export class AdminethimocoleccionComponent implements OnInit {
  @Output() menuAdmin: EventEmitter<any> = new EventEmitter();

  editarRecursos: number = 1;
  tituloadmin = "_"; //ethimocoleccion
  idenlace: number; //ethiocoleccion
  idcoleccion: number ; // coleccion 
  pagi: number = 1;
