...
@Component({
  selector: "app-adminhomecliente",
  templateUrl: "./adminhomecliente.component.html",
})
export class AdminhomeclienteComponent implements OnInit {
  
  @Output() menuAdmin: EventEmitter<any> = new EventEmitter();

  editarRecursos: number = 1;
  tituloadmin = "HOME"; //home
