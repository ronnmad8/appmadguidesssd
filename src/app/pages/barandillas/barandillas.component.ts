...
@Component({
  selector: 'app-barandillas',
  templateUrl: './barandillas.component.html'
})


export class BarandillasComponent implements OnInit{
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = "BARANDILLAS"; //barandillas
  constructor(
