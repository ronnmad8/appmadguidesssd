...
@Component({
  selector: 'app-bioclimaticas',
  templateUrl: './bioclimaticas.component.html'
})


export class BioclimaticasComponent implements OnInit{
    
  idenlaceschildren: number[] = [40,41,42,43];


  idenlace: number = 11; //BIOCLIMATICAS
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //bioclimaticas

  ////2 IMAGO
  link2: string = "/corradi/bioclimaticas/imago";
  posiciont2: number = 2;
  titulo2: string = "IMAGO";
  lema2: string = "";//bd
  ...
  ////4 MAESTRO
  link3: string = "/corradi/bioclimaticas/maestro";
  posiciont3: number = 3;
  titulo3: string = "MAESTRO";
  lema3: string = "";//bd
  ...
  ////4 ALBA
  link4: string = "/corradi/bioclimaticas/alba";
  posiciont4: number = 4;
  titulo4: string = "ALBA";
  lema4: string = "";//bd
  ...
  ////5 ETERIA
  link5: string = "/corradi/bioclimaticas/eteria";
  posiciont5: number = 5;
  titulo5: string = "ETERIA";
  lema5: string = "";//bd
  ...
  {
    this.title.setTitle( "▷ PÉRGOLAS BIOCLIMÁTICAS CORRADI - proyectosxanadu.es");
    this.meta.updateTag({ name: 'description', content: 'Las mejores pérgolas bioclimáticas de la marca Corradi en Madrid y alrededores Modelos Eteria, Maestro, Alba, Imago y mucho más… ' });
    this.meta.updateTag({ name: 'keywords', content: 'Las mejores pérgolas bioclimáticas de la marca Corradi en Madrid y alrededores Modelos Eteria, Maestro, Alba, Imago y mucho más… ' });
    this.meta.updateTag({ name: 'title', content: '▷ Las mejores pérgolas bioclimáticas de la marca Corradi en Madrid y alrededores ✅  Modelos Eteria, Maestro, Alba, Imago y mucho más… ' });
