...
@Component({
  selector: 'app-bioclimaticasproyectos',
  templateUrl: './bioclimaticasproyectos.component.html'
})


export class BioclimaticasproyectosComponent implements OnInit{
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //bioclimaticas proyectos
