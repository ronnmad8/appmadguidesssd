...
@Component({
  selector: 'app-cenadores',
  templateUrl: './cenadores.component.html'
})


export class CenadoresComponent implements OnInit{
    
  idenlace: number = 90;//cenadores
  idtipo: number = 5;
