...
@Component({
  selector: 'app-cortinasabatibles',
  templateUrl: './cortinasabatibles.component.html'
})


export class CortinasabatiblesComponent implements OnInit{
    
  idenlace: number = 77;//cortinasabatibles
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //cortinasabatibles
  constructor(
