...
@Component({
  selector: 'app-cortinascorrederas',
  templateUrl: './cortinascorrederas.component.html'
})


export class CortinascorrederasComponent implements OnInit{
    
  idenlace: number = 76;//cortinascorrederas
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //cortinascorrederas
  constructor(
