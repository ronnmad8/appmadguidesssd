...
@Component({
  selector: 'app-cortinasdecristal',
  templateUrl: './cortinasdecristal.component.html'
})


export class CortinasdecristalComponent implements OnInit{
    
  idenlaceschildren: number[] = [76,77];

  idenlace: number = 21; //cortinasdecristal
  ...
  )
  {
    ...
    this.title.setTitle( "▷ CORTINAS DE CRISTAL - proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: 'Cortinas de cristal en Madrid Cierra tu terraza o restaurante con una cortina de cristal corredera, fijo o abatible. Proyectos Xanadu Madrid  ' });
    this.meta.updateTag({ name: 'keywords', content: 'Cortinas de cristal en Madrid  Cierra tu terraza o restaurante con una cortina de cristal corredera, fijo o abatible. Proyectos Xanadu Madrid ' });
    this.meta.updateTag({ name: 'title', content: '▷Cortinas de cristal en Madrid ✅  Cierra tu terraza o restaurante con una cortina de cristal corredera, fijo o abatible. Proyectos Xanadu Madrid' });
