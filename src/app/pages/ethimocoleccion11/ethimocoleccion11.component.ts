...
@Component({
  selector: "app-ethimocoleccion11",
  templateUrl: "./ethimocoleccion11.component.html",
})
export class Ethimocoleccion11Component implements OnInit {
  idenlace: number = 38;
  idtipo: number = 5;
  idtipotexto: number = 7;
  idcoleccion: number = 11;
