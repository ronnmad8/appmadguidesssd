...
@Component({
  selector: "app-ethimocoleccion12",
  templateUrl: "./ethimocoleccion12.component.html",
})
export class Ethimocoleccion12Component implements OnInit {
  idenlace: number = 39;
  idtipo: number = 5;
  idtipotexto: number = 7;
  idcoleccion: number = 12;
