...
@Component({
  selector: "app-ethimocoleccion13",
  templateUrl: "./ethimocoleccion13.component.html",
})
export class Ethimocoleccion13Component implements OnInit {
  idenlace: number = 83;
  idtipo: number = 5;
  idtipotexto: number = 7;
  idcoleccion: number = 13;
