...
@Component({
  selector: "app-ethimocoleccion14",
  templateUrl: "./ethimocoleccion14.component.html",
})
export class Ethimocoleccion14Component implements OnInit {
  idenlace: number = 84;
  idtipo: number = 5;
  idtipotexto: number = 7;
  idcoleccion: number = 14;
