...
@Component({
  selector: "app-ethimocoleccion15",
  templateUrl: "./ethimocoleccion15.component.html",
})
export class Ethimocoleccion15Component implements OnInit {
  idenlace: number = 85;
  idtipo: number = 5;
  idtipotexto: number = 7;
  idcoleccion: number = 15;
