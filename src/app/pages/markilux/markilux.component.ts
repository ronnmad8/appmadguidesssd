...
@Component({
  selector: "app-markilux",
  templateUrl: "./markilux.component.html",
})
export class MarkiluxComponent implements OnInit {

  idenlace: number = 4; //MARKILUX
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX";

  ////2
  link2: string = "/markilux/toldosbrazosextensibles";
  posiciont2: number = 2;
  titulo2: string = "TOLDOS BRAZOS EXTENSIBLES";
  lema2: string = ""; //bd
  ...
  ////4
  link3: string = "/markilux/toldosveranda";
  posiciont3: number = 3;
  titulo3: string = "TOLDOS VERANDA";
  lema3: string = "";//bd
  ...
  ////4
  link4: string = "/markilux/toldosverticales";
  posiciont4: number = 4;
  titulo4: string = "TOLDOS VERTICALES";
  lema4: string = "";//bd
  ...
  ////5
  link5: string = "/markilux/pergolas";
  posiciont5: number = 5;
  titulo5: string = "PERGOLAS";
  lema5: string = "";//bd
  ...
  constructor(
    ...
    this.title.setTitle( "▷ TOLDOS Y PERGOLAS MAKILUX - proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: ' Conoce los modelos de toldos y pérgolas de Markilux Descubre la comodidad y calidad alemana en tu hogar o negocio en Madrid ' });
    this.meta.updateTag({ name: 'keywords', content: 'Conoce los modelos de toldos y pérgolas de Markilux Descubre la comodidad y calidad alemana en tu hogar o negocio en Madrid ' });
    this.meta.updateTag({ name: 'title', content: '▷ Conoce los modelos de toldos y pérgolas de Markilux ✅ Descubre la comodidad y calidad alemana en tu hogar o negocio en Madrid' });
