...
@Component({
  selector: 'app-markilux1710strech',
  templateUrl: './markilux1710strech.component.html'
})


export class Markilux1710strechComponent implements OnInit{
    

  idenlace: number = 63;//markilux1710strech
  idtipo: number = 5;
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX 1710 strech";
