...
@Component({
  selector: 'app-markilux5010',
  templateUrl: './markilux5010.component.html'
})


export class Markilux5010Component implements OnInit{
    

  idenlace: number = 60;//markilux5010
  idtipo: number = 5;
