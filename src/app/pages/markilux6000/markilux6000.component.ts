...
@Component({
  selector: 'app-markilux6000',
  templateUrl: './markilux6000.component.html'
})


export class Markilux6000Component implements OnInit{
    

  idenlace: number = 61;//markilux6000
  idtipo: number = 5;
