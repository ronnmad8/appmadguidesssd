...
@Component({
  selector: 'app-markilux620tracfix',
  templateUrl: './markilux620tracfix.component.html'
})


export class Markilux620tracfixComponent implements OnInit{
    

  idenlace: number = 68;//markilux620tracfix
  idtipo: number = 5;
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX 620 tracfix";
