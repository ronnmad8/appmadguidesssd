...
@Component({
  selector: 'app-markilux770',
  templateUrl: './markilux770.component.html'
})


export class Markilux770Component implements OnInit{
    

  idenlace: number = 64;//markilux770
  idtipo: number = 5;
