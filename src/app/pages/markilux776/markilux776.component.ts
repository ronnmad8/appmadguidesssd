...
@Component({
  selector: 'app-markilux776',
  templateUrl: './markilux776.component.html'
})


export class Markilux776Component implements OnInit{
    

  idenlace: number = 67;//markilux776
  idtipo: number = 5;
