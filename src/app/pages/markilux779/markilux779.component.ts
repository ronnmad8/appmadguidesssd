...
@Component({
  selector: 'app-markilux779',
  templateUrl: './markilux779.component.html'
})


export class Markilux779Component implements OnInit{
    

  idenlace: number = 66;//markilux779
  idtipo: number = 5;
