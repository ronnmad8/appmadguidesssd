...
@Component({
  selector: 'app-markilux8800',
  templateUrl: './markilux8800.component.html'
})


export class Markilux8800Component implements OnInit{
    

  idenlace: number = 65;//markilux8800
  idtipo: number = 5;
