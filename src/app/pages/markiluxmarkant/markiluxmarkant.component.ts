...
@Component({
  selector: 'app-markiluxmarkant',
  templateUrl: './markiluxmarkant.component.html'
})


export class MarkiluxmarkantComponent implements OnInit{
    

  idenlace: number = 56;//markiluxmarkant
  idtipo: number = 5;
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX MARKANT";
