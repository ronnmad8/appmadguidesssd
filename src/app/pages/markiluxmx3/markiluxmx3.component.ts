...
@Component({
  selector: 'app-markiluxmx3',
  templateUrl: './markiluxmx3.component.html'
})


export class Markiluxmx3Component implements OnInit{
    

  idenlace: number = 59;//markiluxmx3
  idtipo: number = 5;
