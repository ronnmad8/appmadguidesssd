...
@Component({
  selector: 'app-markiluxpergola',
  templateUrl: './markiluxpergola.component.html'
})


export class MarkiluxpergolaComponent implements OnInit{
    

  idenlace: number = 57;//markiluxpergola
  idtipo: number = 5;
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX PERGOLA";
