...
@Component({
  selector: 'app-markiluxstrech',
  templateUrl: './markiluxstrech.component.html'
})


export class MarkiluxstrechComponent implements OnInit{
    

  idenlace: number = 58;//markiluxstrech
  idtipo: number = 5;
  ...
  link1: string = "/";
  posiciont1: number = 1;
  titulo1: string = "MARKILUX STRECH";
