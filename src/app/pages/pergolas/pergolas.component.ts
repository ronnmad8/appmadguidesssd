...
export class PergolasComponent implements OnInit{
    

  idenlace: number = 28; //PERGOLAS
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = "PERGOLAS";

  ////2 MarkiluxMarkant
  link2: string = "/markilux/pergolas/markiluxmarkant";
  posiciont2: number = 2;
  titulo2: string = "MARKILUX MARKANT";
  lema2: string = "";//bd
  ...
  ////4 Markiluxpergola
  link3: string = "/markilux/pergolas/markiluxpergola";
  posiciont3: number = 3;
  titulo3: string = "MARKILUX PERGOLA";
  lema3: string = "";//bd
  ...
  ////4 MarkiluxOTRO
  link4: string = "/markilux/pergolas/markiluxstrech";
  posiciont4: number = 4;
  titulo4: string = "MARKILUX STRECH";
  lema4: string = "";//bd
  ...
  )
  {
    ...
    this.title.setTitle( "▷ PÉRGOLAS- proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: ' Catálogo de pérgolas Pérgolas Markilux con lona en madera y metal. Instalaciones a medida para espacios públicos y privados Madrid ' });
    this.meta.updateTag({ name: 'keywords', content: ' Catálogo de pérgolas Pérgolas Markilux con lona en madera y metal. Instalaciones a medida para espacios públicos y privados Madrid' });
    this.meta.updateTag({ name: 'title', content: '▷ Catálogo de pérgolas Pérgolas Markilux con lona en madera y metal. Instalaciones a medida para espacios públicos y privados Madrid' });
