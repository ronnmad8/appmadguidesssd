...
@Component({
  selector: 'app-pergolashierromadera',
  templateUrl: './pergolashierromadera.component.html'
})


export class PergolashierromaderaComponent implements OnInit{
    
  idenlace: number = 73;//pergolashierromadera
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //pergolashierromadera
  constructor(
