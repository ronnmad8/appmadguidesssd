...
@Component({
  selector: 'app-pergolaslona',
  templateUrl: './pergolaslona.component.html'
})


export class PergolaslonaComponent implements OnInit{
    
  idenlace: number = 82;//pergolaslona
  idtipo: number = 5;
