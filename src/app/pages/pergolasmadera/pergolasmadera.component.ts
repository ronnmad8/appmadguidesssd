...
@Component({
  selector: 'app-pergolasmadera',
  templateUrl: './pergolasmadera.component.html'
})


export class PergolasmaderaComponent implements OnInit{
    
  idenlace: number = 72;//pergolasmadera
  idtipo: number = 5;
