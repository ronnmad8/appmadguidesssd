...
@Component({
  selector: 'app-pergolasproyectos',
  templateUrl: './pergolasproyectos.component.html'
})


export class PergolasproyectosComponent implements OnInit{
    
  idenlaceschildren: number[] = [72,73,82];

  idenlace: number = 19; //pergolaproyectos
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = "PÉRGOLAS PROYECTOS";
  ...
  )
  {
    ...
    this.title.setTitle( "▷ PÉRGOLAS EN MADRID - proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: ' Pérgolas a medida para tu terraza o jardín Pérgolas de madera, pérgolas de hierro, pergolas de lona… todo tipo de cerramientos Xanadú ' });
    this.meta.updateTag({ name: 'keywords', content: ' Pérgolas a medida para tu terraza o jardín Pérgolas de madera, pérgolas de hierro, pergolas de lona… todo tipo de cerramientos Xanadú' });
    this.meta.updateTag({ name: 'title', content: '▷ Pérgolas a medida para tu terraza o jardín ✅  Pérgolas de madera, pérgolas de hierro, pergolas de lona… todo tipo de cerramientos Xanadú' });
