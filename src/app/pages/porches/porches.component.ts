...
@Component({
  selector: 'app-porches',
  templateUrl: './porches.component.html'
})


export class PorchesComponent implements OnInit{
    
  idenlaceschildren: number[] = [70,71];

  idenlace: number = 18; //porches
  ...
  )
  {
    ...
    this.title.setTitle( "▷ PORCHES A MEDIDA - proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: ' Porches modernos y rústicos En proyectos Xanadú adaptamos el porche al estilo de tu porpiedad en Madrid, porches a medida… ' });
    this.meta.updateTag({ name: 'keywords', content: ' Porches modernos y rústicos En proyectos Xanadú adaptamos el porche al estilo de tu porpiedad en Madrid, porches a medida…' });
    this.meta.updateTag({ name: 'title', content: '▷ Porches modernos y rústicos ✅  En proyectos Xanadú adaptamos el porche al estilo de tu porpiedad en Madrid, porches a medida…' });
