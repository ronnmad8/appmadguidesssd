...
@Component({
  selector: 'app-porcheshierromadera',
  templateUrl: './porcheshierromadera.component.html'
})


export class PorcheshierromaderaComponent implements OnInit{
    
  idenlace: number = 71;//porches madera
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //porcheshierromadera
  constructor(
