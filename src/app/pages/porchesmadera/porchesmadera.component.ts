...
@Component({
  selector: 'app-porchesmadera',
  templateUrl: './porchesmadera.component.html'
})


export class PorchesmaderaComponent implements OnInit{
    
  idenlace: number = 70;//porchesmadera
  idtipo: number = 5;
