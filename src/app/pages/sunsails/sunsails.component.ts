...
@Component({
  selector: 'app-sunsails',
  templateUrl: './sunsails.component.html'
})


export class SunsailsComponent implements OnInit{
    
  idenlaceschildren: number[] = [45,46,47];

  idenlace: number = 13; //sunsails
  ...
  )
  {
    ...
    this.title.setTitle( "▷ SUN SAILS de CORRADI - proyectosxanadu.es");
    this.meta.updateTag({ name: 'description', content: 'Descubre la mejor selección de Sun Sails Corradi Velas de sombra de diseño italiano en Madrid. Modelos Defense, Maestrale, Scirocco ' });
    this.meta.updateTag({ name: 'keywords', content: 'Descubre la mejor selección de Sun Sails Corradi Velas de sombra de diseño italiano en Madrid. Modelos Defense, Maestrale, Scirocco ' });
    this.meta.updateTag({ name: 'title', content: '▷ Descubre la mejor selección de Sun Sails Corradi ✅ Velas de sombra de diseño italiano en Madrid. Modelos Defense, Maestrale, Scirocco ' });
