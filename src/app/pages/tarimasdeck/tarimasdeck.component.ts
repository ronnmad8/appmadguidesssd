...
@Component({
  selector: 'app-tarimasdeck',
  templateUrl: './tarimasdeck.component.html'
})


export class TarimasdeckComponent implements OnInit{
    
  idenlace: number = 78;//tarimasdeck
  idtipo: number = 5;
