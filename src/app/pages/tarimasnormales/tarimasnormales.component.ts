...
@Component({
  selector: 'app-tarimasnormales',
  templateUrl: './tarimasnormales.component.html'
})


export class TarimasnormalesComponent implements OnInit{
    
  idenlace: number = 79;//tarimasnormales
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //tarimasnormales
  constructor(
