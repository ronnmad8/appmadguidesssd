...
@Component({
  selector: 'app-techofijoevolution',
  templateUrl: './techofijoevolution.component.html'
})


export class TechofijoevolutionComponent implements OnInit{
    
  idenlace: number = 74;//techofijoevolution
  idtipo: number = 5;
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = ""; //techofijoevolution
  constructor(
