...
@Component({
  selector: 'app-techofijoiskar',
  templateUrl: './techofijoiskar.component.html'
})


export class TechofijoiskarComponent implements OnInit{
    
  idenlace: number = 75;//techofijoiskar
  idtipo: number = 5;
