...
@Component({
  selector: 'app-techosmoviles',
  templateUrl: './techosmoviles.component.html'
})


export class TechosmovilesComponent implements OnInit{
  ...
  link1: string = "";
  posiciont1: number = 1;
  titulo1: string = "TECHOS MOVILES"; //techos moviles
