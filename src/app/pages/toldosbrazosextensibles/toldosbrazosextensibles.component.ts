...
@Component({
  selector: 'app-toldosbrazosextensibles',
  templateUrl: './toldosbrazosextensibles.component.html'
})


export class ToldosbrazosextensiblesComponent implements OnInit{
    

  idenlaceschildren: number[] = [59,60,61,62,63];

  idenlace: number = 14; //toldosbrazosextensibles
  ...
  {
    this.title.setTitle( "▷ TOLDO BRAZO EXTENSIBLE- proyectosxanadu.es");
    this.meta.updateTag({ name: 'description', content: ' Toldos con brazos extensibles Markilux  Conoce todos los modelos de toldos para terrazas, jardines, patios, con distintas lonas en Xanadú ' });
    this.meta.updateTag({ name: 'keywords', content: 'Toldos con brazos extensibles Markilux  Conoce todos los modelos de toldos para terrazas, jardines, patios, con distintas lonas en Xanadú' });
    this.meta.updateTag({ name: 'title', content: '▷ Toldos con brazos extensibles Markilux ✅  Conoce todos los modelos de toldos para terrazas, jardines, patios, con distintas lonas en Xanadú' });
