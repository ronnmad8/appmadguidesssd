...
@Component({
  selector: 'app-toldosverticales',
  templateUrl: './toldosverticales.component.html'
})


export class ToldosverticalesComponent implements OnInit{

    
  idenlaceschildren: number[] = [67,68];

  idenlace: number = 16; //toldosverticales
  ...
  )
  {
    ...
    this.title.setTitle( "▷ TOLDOS VERTICALES- proyectosxanadu.es ");
    this.meta.updateTag({ name: 'description', content: ' Toldos verticales Markilux Toldos verticales a medida verticales para patios jardines o terrazas. Presupuestos con Proyectos Xanadú ' });
    this.meta.updateTag({ name: 'keywords', content: 'Toldos verticales Markilux Toldos verticales a medida verticales para patios jardines o terrazas. Presupuestos con Proyectos Xanadú ' });
    this.meta.updateTag({ name: 'title', content: '▷ Toldos verticales Markilux ✅  Toldos verticales a medida verticales para patios jardines o terrazas. Presupuestos con Proyectos Xanadú' });
