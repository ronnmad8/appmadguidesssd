...
export class VisitaService {
  ...
  getImagenesvisita()  {
        ...
        imagen1.url = "../../assets/images/imagen-footer.jpg";
        imagen1.url_movil = "../../assets/images/imagen-footer.jpg";
        imagen1.url_galleria = "../../assets/images/imagen-footer.jpg";
  ...
  getRelacionadas(category_uuid: string)  {
    let endpoint = '/visit?order=order-random&per_page=4&category_uuid=' + category_uuid;
    this.url = this.apiurl + endpoint;
    ...
    .pipe(
      map( resp =>{
        ...
        var relacionadas: VisitasResultadoModel[] = resp as VisitasResultadoModel[];
        return relacionadas;   
      } ) ,
      catchError((err) => {
        console.error("Error  " , err.error);
